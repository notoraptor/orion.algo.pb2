# -*- coding: utf-8 -*-
#
# orion.algo.pb2 documentation build configuration file.
#
...
import orion.algo.pb2 as algo_plugin
...
man_pages = [(master_doc, "projectname", "Oríon algo pb2 Documentation", [author], 1)]
