...
class PB2(BaseAlgorithm):
    ...
    def __init__(self, space, seed=None):
        super(PB2, self).__init__(space, seed=seed)
    ...
    def state_dict(self):
        ...
        state_dict = super(PB2, self).state_dict
        # TODO: Adapt this to your algo
    ...
    def set_state(self, state_dict):
        ...
        """
        # TODO: Adapt this to your algo
        super(PB2, self).set_state(state_dict)
        self.seed_rng(0)
    ...
    def observe(self, trials):
        ...
        super(PB2, self).observe(trials)

    @property
    def is_done(self):
        """Return True, if an algorithm holds that there can be no further improvement."""
        # NOTE: Drop if base implementation is fine.
        return super(PB2, self).is_done
